...
function CrewForm(props){
    ...
    useState(() => {
        if (props.itemId){
            fetch('/db/crew/'+props.itemId).then(res => res.text()).then(res => {
                console.log(res);
    ...
    function onSubmitClick(){
        ...
        const newCrewMember = { name, job, type, picture, about }
        ...
        $.ajax({
            ...
            window.location.href =  props.type === "edit" ? "/admin/edit/crew/" + parseInt(props.itemId) : "/admin/crew/"
        })
        ...
        <div className="crew-form">
            <div className="ui grid">
                ...
                <div className="twelve wide column ">
                    ...
                    <input placeholder="job" type="text" value={job} onChange={e => setJob(e.target.value)}/>
