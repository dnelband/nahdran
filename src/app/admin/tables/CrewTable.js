        ...
        <div>
            <div className="section-header ui secondary menu">
                ...
                <div className="ui right menu secondary">
                    <div>
                        <a href="/admin/create/crew" className="ui green button labeled icon">
...
function CrewTableItem(props){
    ...
    return (
        <tr> 
            ...
            <td><img width="50" src={__dirname + cm.picture}/></td>
            <td>{cm.name}</td>
            <td>{cm.job}</td>
            <td>{cm.type ? cm.type : 'crew'} </td>
            <td>{cm.about}</td>
            <td>
                <a href={"/admin/edit/crew/"+cm.crew_id} className="ui primary button icon">
                    <i className="pencil icon"></i>
                </a>
                <button onClick={onDeleteCrewMemberClick} className="ui red button icon">
