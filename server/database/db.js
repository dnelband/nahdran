      ...
      err => {
        if (err) {
          ...
          db.run(insert, [
            1,
            'html',
            '<div><h3>hello im the test conent item</h3></div>',
          ]);
    ...
    db.run(
      ...
      err => {
        if (err) {
          ...
          db.run(insert, [
            'first news item',
            'the movie had won 10000 awards in every category wow how cool yeah woohoo',
          ]);
        }
      }
    );
      ...
      err => {
        if (err) {
          ...
          db.run(insert, [
            ...
            'Director',
            'pictures/Elisa.jpg',
            'elisa fucking nelband MOTHER FUCKING BIATCH N******AAAAA ****** and ****** BOOOM',
            1,
          ]);
        }
      }
